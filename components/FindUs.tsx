...
const markets = [
  {
    day: 'Sat',
    market: 'Jan Powers Farmers Market',
    location: 'Powerhouse, New Farm',
    time: '6am – 12pm',
    frequency: 'Fortnightly',
  },
  {
    day: 'Sat',
    market: 'West End Markets',
  ...
  {
    day: 'Sun',
    market: 'South Bank Lifestyle Markets',
  ...
  {
    day: 'Sun',
    market: 'Northey Street Organic Market',
    location: 'Windsor',
    time: '6am – 12pm',
    frequency: 'Weekly',
  },
...
const events = [
  {
    date: 'TBC',
    title: 'Brisbane Tiramisu Pop-up',
    location: 'Location TBC, Brisbane',
    note: 'Follow us on Instagram for the confirmed date',
  },
  {
    date: 'TBC',
    title: 'Valentine Collection Drop',
    location: 'Private location, inner-city',
    note: 'Limited editions available for pre-order',
  },
  {
    date: 'TBC',
    title: 'Powerhouse Night Market',
    location: 'Brisbane Powerhouse, New Farm',
    note: 'Evening pop-up with seasonal specials',
  },
]
